...
\begin{proof}
    ...
    se sopra la casella di $a+1$ c\`e la lettera $a+2$, allora anche l'inserimento
    di $a+1$ sar\`a speciale e la riga sopra non varia;
    altrimenti, si conclude come nel caso dell'inserimento regolare.
...
Ricordiamo che il peso di un tableaux semistandard $T$ \`e il vettore di interi
...
\begin{proof}
        ...
        \begin{tikzpicture}[remember picture]
            \node (T1) {
                    \ytableaunumber{
                        ...
                        {\tmn{A11}{ 1}} {\tmn{A12}{ 2}} {\tmn{A13}{ 4}} {\tmn{A14}{ 5}} {\tmn{A15}{ 7}} {\tmn{A16}{10}} {\tmn{A17}{13}} {\tmn{A18}{15}}
                    }
                };
    ...
    quello di $x_{k+1}$ se e solo se c'\`e una buca.
    ...
    Verifichiamo infine che tutte le parentesi aperte corrispondenti a
    $x_{j+s+1}, \dots, x_{\alpha_i}$ sono appaiate con parentesi chiuse tra quelle
