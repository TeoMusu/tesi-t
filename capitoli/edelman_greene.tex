...
si dimostra essere uguale al numero di inversioni di $\w$.
...
% TODO aggiungi cose su EG e RSK ma forse basta
...
\begin{example}
    ...
    Per ogni riga ho colorato la casella che conteneva la lettera che \`e
    stata spinta nella riga successiva.
    In particolare, quando avviene un inserimento speciale, coloro la casella
    di $k+1$.
...
\begin{proposition}[Propriet\`a del $P$-tableau EG]
    ...
    \end{enumerate}
    % TODO aggiungere eventuali propriet\`a del P-tableau
\end{proposition}
