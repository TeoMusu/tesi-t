...
\begin{definition}
    ...
    % TODO UTILIZZA questa notazione
\end{definition}
...
i_u \\
    ...
    \item \label{item:eg_ins3}
        ...
        $k+1$. In questo caso diciamo che \`e avvenuto in inserimento \emph{speciale}.
...
affich\'e $a_\w^\lambda$ sia diverso da zero.
...
% TODO ribadisco definire queste schur.
...
\begin{proof}
    ...
    scavalca quello di $x_j$ alla propria sinistra esattamente in corrispondeza
    ...
    non appaiata si trova in corrispondeza dell'ultimo percorso che devia, ovvero
    ...
    Verifichiamo infine che tutte le parentesi chiuse corrispondenti
    ...
    vale $ y_{k+r} < x_{j+r} $, da cui prima di ogni parentesi chiusa di $x_{j+r}$
    compare dopo quella aperta di $y_{k+r}$.
