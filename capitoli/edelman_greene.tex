...
\begin{proof}
    ...
    % TODO: tutto sbagliato, rifare
    Per prima cosa sposto a sinistra le lettere del primo blocco del
    secondo fattore.
    La sua lettera pi\`u piccola \`e minore della pi\`u piccola lettera 
    appaiata del primo fattore (altrimenti quest'ultima non sarebbe appaiata), 
    quindi si pu\`o muovere verso sinistra fino a raggiungerla. 
    Nel nostro esempio otteniamo:
    \[
        ( \mathbf{1}, 2 \text{-} 1, \mathbf{3}, 9, 11 \mid \mathbf{12}, 13, 14 \mid 18 ) \,
        ( 5, 8 \mid 12, 13 \mid \mathbf{15}, 16).
    \]
    Un simile ragionamento pu\`o essere ripetuto per le successive lettere,
    trascurando le coppie che si sono gi\`a avvicinate (come $2$ e $1$ nell'esempio).
    Allora, nell'esempio, $5$ si muove fino a $9$ e $8$ si muove fino a $11$, ottenendo:
    \[
        ( \mathbf{1}, 2 \text{-} 1, \mathbf{3}, 9 \text{-} 5,
        11 \text{-} 8\mid \mathbf{12}, 13, 14 \mid 18 ) \,
        ( 12, 13 \mid \mathbf{15}, 16).
    \]
    Nello stesso modo le lettere del terzo blocco del primo fattore si muovono a destra:
    \[
        ( \mathbf{1}, 2 \text{-} 1, \mathbf{3}, 9 \text{-} 5,
    ...
    sono gi\`a operazioni di Coxeter-Knuth, ottendo
    \[
        ( \mathbf{1}, 2 \text{-} 1, \mathbf{3}, 9 \text{-} 5,
        11 \text{-} 8\mid  13, 14  ) \,
        ( 12, 13, \mathbf{14} \mid \mathbf{15}, 18 \text{-} 16).
    \]
    Alla fine, tutte le lettere spostate possono ritornare alle loro posizioni originali,
    ottenendo
    \[
        f_1(v) = 
...
\begin{proof}
    ...
    parole Coxeter-Knuth equivalenti hanno lo stesso $P$-tableau.

    Per dimostrare il punto~??2 
