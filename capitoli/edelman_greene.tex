...
\chapter{Corrispondenza Edelman--Greene}
...
In questo capitolo descriviamo la corrispondenza di Edelman e Greene (EG), 
introdotta da loro in \cite[Section~6]{edelman-greene-87} come una variante
della pi\`u famosa corrispondenza di Robinson, Schensted e Knuth (RSK),
...
\begin{example}
    ...
    \[ 
        ...
        \qquad
        \ytableaunumber{4 \none {\none[\leftarrow 5]}, 3  4 {*(green) 5}, 1 2 {*(green) 3} 6 }
        \qquad
        \ytableaunumber{4 {*(green) 5}, 3 4 {*(green) 5} , 1 2 {*(green) 3} 6 }.
    \]
...
\begin{proof}
    ...
    \begin{align*}
        ...
        {\scriptstyle <a} {\scriptstyle <a} { a} {*(green) \scriptstyle a+1} }
        * {4,5}
        &&\text{ se $a=b$; } 
        \\[1em]
        &\ytableaushort 
...
la corrispondenza Edelman--Greene pu\`o
...
\begin{proof}
    ...
    la mappa $Q$ di Edelman e Greene.
