...
\begin{proof}
    ...
    $a_2 \leq b$.
    \[
        % TODO aggiungi i path
        \ytableaushort{
            {a_2},
            \none {a_1} {c_1} {c_2} {\cdots} {b} \none {\none[\leftarrow d]}
        }
    \]
        ...
        \begin{tikzpicture}[remember picture]
            \node (T1) {
                    \ytableaunumber{
                        ...
                        {\tmn{A31}{ 6}} {\tmn{A32}{ 7}} {\tmn{A33}{12}} {\tmn{A34}{15}} {\tmn{A35}{16}} {\tmn{A36}{17}} {\tmn{A47}{18}},
            ...
            \end{scope}
        \end{tikzpicture}
        % TODO cambia il tableau e aggiungi i percorsi.
        \caption{L'inserimento del tableau della Figura~\ref{fig:tab_con_insertionp}
